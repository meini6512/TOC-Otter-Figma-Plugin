...
TOC Otter 🦦 is a clean, minimalist navigation tool that turns your Figma headers into a table of contents.
...
- To include a frame/section in your table of contents, simply add a **#** prefix to its name. For example: # Homepage
